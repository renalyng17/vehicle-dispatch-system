      ...
      <div className="bg-opacity-90 rounded-xl p-11 w-90 max-w-md z-10">
        ...
        <form className="space-y-4" onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            disabled={loading}
            className={`w-full py-2 bg-green-600 text-white rounded-md hover:bg-green-700 transition text-xs flex justify-center items-center ${loading ? 'opacity-70 cursor-not-allowed' : ''}`}
          >
            {loading ? (
              <>
