...
function Profile() {
  ...
  const handleSave = async () => {
    try {
      ...
      alert("Failed to save: Please check your internet connection and try again.");
    } finally {
      setIsLoading(false);
    }
  };
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between">
            ...
            {!isEditing && (
              ...
              >
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2 text-gray-500 group-hover:text-green-600" viewBox="0 0 20 20" fill="currentColor">
                  <path d="M13.586 3.586a2 2 0 112.828 2.828l-.793.793-2.828-2.828.793-.793zM11.379 5.793L3 14.172V17h2.828l8.38-8.379-2.83-2.828z" />
                </svg>
                <span className="font-medium text-gray-700 group-hover:text-green-600">Edit Profile</span>
              </button>
            )}
          </div>
          ...
          <div className="p-8 flex flex-col lg:flex-row">
            ...
            <div className="lg:w-1/4 flex flex-col items-center lg:items-start lg:pr-8 mb-8 lg:mb-0">
              <div className="relative group">
                ...
                {isEditing && (
                  <button className="absolute bottom-2 right-2 bg-white p-2 rounded-full shadow-md border border-gray-200">
              ...
              {isEditing && (
                <div className="flex justify-end space-x-3 pt-6 border-t border-gray-100">
                  <button
                    ...
                    className="px-6 py-2.5 border border-gray-200 rounded-lg text-gray-700 hover:bg-gray-50 font-medium"
                  >
                    Cancel
                  </button>
                  <button
                    onClick={handleSave}
                    disabled={isLoading}
                    className="px-6 py-2.5 bg-green-600 text-white rounded-lg hover:bg-green-700 font-medium flex items-center disabled:opacity-70"
                  >
                    {isLoading ? (
                      <>
